...
export default {
    ...
    methods: {
        ...
        render() {
            ...
            // Paddles
            this.drawImage(playerPaddle, this.paddles.user.width, this.paddles.user.height, this.paddles.user.x, this.paddles.user.y)
            this.drawImage(computerPaddle, this.paddles.computer.width, this.paddles.computer.height, this.paddles.computer.x, this.paddles.computer.y);

            // Ball
            // this.drawCircle(this.ball.x, this.ball.y, this.ball.radius, 'red')

            let ball = document.getElementById('pongBall');
            this.drawImage(ball, this.ball.radius, this.ball.radius, this.ball.x, this.ball.y)
        },
        ...
        update() {
            ...
            if (this.ball.y + this.ball.radius > this.canvas.height || this.ball.y + this.ball.radius < this.ball.radius) {
        ...
        drawImage(img, x, y, w, h) {
            this.context.drawImage(img, w, h, x, y);
        }
    }
}
</script>
